...
public class Constant implements Serializable {
	...
	public static final String SERVER_IMAGE_UPFOLDER_CATEGORY="http://viaviweb.in/Apps/HD-wallpaper-client/categories/";
	
	//this is the path of uploaded image of server where image store
	public static final String SERVER_IMAGE_UPFOLDER_THUMB="http://viaviweb.in/Apps/HD-wallpaper-client/images/thumbs/";
	...
	public static final String LATEST_URL = "http://viaviweb.in/Apps/HD-wallpaper-client/api.php?latest=15";
	//this url gives list of category in 2nd tab
	public static final String CATEGORY_URL = "http://viaviweb.in/Apps/HD-wallpaper-client/api.php";
	//this url gives item of specific category.
	public static final String CATEGORY_ITEM_URL = "http://viaviweb.in/Apps/HD-wallpaper-client/api.php?cat_id=";
