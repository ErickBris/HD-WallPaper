...
public class SlideImageActivity extends SherlockActivity implements SensorEventListener {
	...
	{       
        ...
        case R.id.menu_share:
        	...
        	(new ShareTask(SlideImageActivity.this)).execute(Constant.SERVER_IMAGE_UPFOLDER_CATEGORY+mAllImageCatName[position]+"/"+mAllImages[position]);
        ...
        case R.id.menu_save:
        	...
        	(new SaveTask(SlideImageActivity.this)).execute(Constant.SERVER_IMAGE_UPFOLDER_CATEGORY+mAllImageCatName[position]+"/"+mAllImages[position]);
	...
	private class ImagePagerAdapter extends PagerAdapter {
	    ...
	    public Object instantiateItem(ViewGroup container, int position) {
			...
			final ProgressBar spinner = (ProgressBar) imageLayout.findViewById(R.id.loading);
			 ...
			 ImageLoader.getInstance().displayImage(Constant.SERVER_IMAGE_UPFOLDER_CATEGORY+mAllImageCatName[position]+"/"+mAllImages[position], imageView, options, new SimpleImageLoadingListener() {
					@Override
		  ...
		  protected void onPause() {
			...
			public class SaveTask extends AsyncTask<String , String , String>
			{
			    ...
			    protected void onPostExecute(String args) {
			        // TODO Auto-generated method stub
			    	Toast.makeText(SlideImageActivity.this, "Image Saved Succesfully HD Wallpaper/", Toast.LENGTH_SHORT).show();
			        pDialog.dismiss();
			    }
			}
